...
func (s *PermissionSeeder) Run() error {
	...
	permissions := []models.Permission{
		...
		{Name: "附件删除", Slug: "attachment.destroy", Method: "DELETE", Path: "/api/admin/attachments/*", Description: "删除附件", Status: 1, Sort: 8, MenuID: attachmentMenu.ID},
		{Name: "附件批量删除", Slug: "attachment.batch_delete", Method: "POST", Path: "/api/admin/attachments/batch-delete", Description: "批量删除附件", Status: 1, Sort: 9, MenuID: attachmentMenu.ID},
		{Name: "附件分类列表", Slug: "attachment_category.index", Method: "GET", Path: "/api/admin/attachment-categories", Description: "查看附件分类列表", Status: 1, Sort: 10, MenuID: attachmentMenu.ID},
		{Name: "附件分类详情", Slug: "attachment_category.show", Method: "GET", Path: "/api/admin/attachment-categories/*", Description: "查看附件分类详情", Status: 1, Sort: 11, MenuID: attachmentMenu.ID},
		{Name: "附件分类创建", Slug: "attachment_category.store", Method: "POST", Path: "/api/admin/attachment-categories", Description: "创建附件分类", Status: 1, Sort: 12, MenuID: attachmentMenu.ID},
		{Name: "附件分类更新", Slug: "attachment_category.update", Method: "PUT", Path: "/api/admin/attachment-categories/*", Description: "更新附件分类", Status: 1, Sort: 13, MenuID: attachmentMenu.ID},
		{Name: "附件分类删除", Slug: "attachment_category.destroy", Method: "DELETE", Path: "/api/admin/attachment-categories/*", Description: "删除附件分类", Status: 1, Sort: 14, MenuID: attachmentMenu.ID},
		// Dashboard 统计
